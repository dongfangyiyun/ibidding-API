...
class Admin extends Validate
{
    ...
    protected $scene = [
        ...
        'update'      => ['guid' => 'checkHasValue:guid', 'password' => 'min:6|max:15', 'mobile', 'name', 'user_name', 'nick_name', 'telephone', 'qq', 'wechat', 'email', 'status', 'role_ids', 'id'],
        'update_self' => ['guid' => 'checkHasValue:guid', 'password' => 'min:6|max:15', 'mobile', 'name', 'user_name', 'nick_name', 'telephone', 'qq', 'wechat', 'email', 'id'],
    ];
