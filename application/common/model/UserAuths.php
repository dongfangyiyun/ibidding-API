...
class UserAuths extends BaseModel
{
    ...
    protected static function init()
    {
        ...
        self::beforeWrite(function ($model) {
            if ($model->id_card_front_img) {
                $model->id_card_front_img = isset($model->data['id_card_front_img']) ? base64_to_img([$model->data['id_card_front_img']], 400)[0] : '';
            }

            if ($model->id_card_back_img) {
                $model->id_card_back_img = isset($model->data['id_card_back_img']) ? base64_to_img([$model->data['id_card_back_img']], 400)[0] : '';
            }
