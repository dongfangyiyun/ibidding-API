...
{
    protected $rule = [
        ['table_name', 'require|checkHasValue:table_name', '表名不能为空'],
        ['attr', 'require|max:50|checkHasValue:attr', '表列名不能为空|表列名最大限50字符'],
        ['abbr', 'require|max:20|checkHasValue:abbr', '表列名英文缩写不能为空|表列名英文缩写最大限20字符'],
