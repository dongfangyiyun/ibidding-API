...
class Helper extends Rest
{
    protected $beforeActionList = [
        'checkClientType',
        'checkAuth',
        'checkToken' => ['except' => 'send_code,check_code'],
    ];
    ...
    public function qrcode()
    {
        ...
        $this->data['data'] = get_host() . qrcode('IbiddingAPI://' . $order_no);
    ...
    public function upload_file()
    {
        ...
        if ($file) {
            if ($save_path) {
                if ($save_path == '/') {
                    $info = $file->move(ROOT_PATH, false);
                } else {
                    $info = $file->move(ROOT_PATH . $save_path, false);
                }
            } else {
                $info = $file->move(ROOT_PATH . 'public' . DS . 'upload', false);
            }
