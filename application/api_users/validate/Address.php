...
{
    protected $rule = [
        ['id', 'require|checkHasValue:id', '地址ID不能为空'],
        ...
        ['province_code', 'require|checkHasValue:province_code', '省份编码不能为空'],
        ['city_code', 'require|checkHasValue:city_code', '城市编码不能为空'],
        ['area_code', 'require|checkHasValue:area_code', '地区编码不能为空'],
